...
const Footer = () => {
  ...
  const propertyTypes = [
    { title: "Apartments in Coimbatore", href: "/properties?type=Apartment" },
    { title: "Villas in Coimbatore", href: "/properties?type=Villa" },
    { title: "Plots in Coimbatore", href: "/properties?type=Plot" },
    { title: "Luxury Homes", href: "/properties" },

  ];

  const cities = [
    { title: "Saravanampatti", href: "/properties?area=Saravanampatti" },
    { title: "Peelamedu", href: "/properties?area=Peelamedu" },
    { title: "Vadavalli", href: "/properties?area=Vadavalli" },
    { title: "Race Course", href: "/properties?area=Race Course" },
    { title: "Gandhipuram", href: "/properties?area=Gandhipuram" }
  ];
